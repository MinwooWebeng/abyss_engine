...
namespace AbyssCLI.AML
{
    ...
    public class Vector3
    {
        ...
        {
            var parsed_x = TypeConv.ToArray(x, 3);
    ...
    public class Quaternion
    {
        ...
        {
            var parsed_x = TypeConv.ToArray(x, 4);
    ...
    internal static class TypeConv
    {
        ...
        {
            if (value is Microsoft.ClearScript.Undefined) return 0f;
        ...
        internal static object[] ToArray(object value, int minlength = 0)
        {
            ...
            {
                var given_length = list.GetProperty("length") as int? ?? 0;
                var length = minlength < given_length ? given_length : minlength;
